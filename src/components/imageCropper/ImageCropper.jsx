...
import { getCroppedImageFromFile } from "./helpers/getCroppedImgFromFile";
import { Loader } from "@/components/ui/loader/Loader";
import { getInitialCrop } from "./helpers/getInitialCrop";
      ...
      <div className={styles.cropperContainer}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.buttonsContainer}>
            <Button mode="default" children="Cancelar" onClick={onCropCancel} />
            <Button mode="primary" children="Confirmar" onClick={() => setIsModalVisible(true)} />
          </div>
        </div>
      </div>
